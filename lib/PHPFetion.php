...
class PHPFetion
{
    ...
    /**
     * Pring out debug information
     * @param string $info
     */
    protected function _debug($info) {
        print_r($info);
        echo "</br></br>";
    }
